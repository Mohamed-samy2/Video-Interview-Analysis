...
const HrRoutes = (
  <>
    ...
    <Route path="jobs/:id" element={<HrProtectedRoute><Suspense fallback={<div>Loading...</div>}><JobDetails isHr={true} /></Suspense></HrProtectedRoute>} />
