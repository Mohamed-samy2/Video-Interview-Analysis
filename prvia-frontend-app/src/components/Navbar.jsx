...
// const CustomNavbar = () => {
//   const { isLoggedIn, logout, hrId } = useAuth();
//   const navigate = useNavigate();
...
//           {isLoggedIn && hrId && (
//             <>
//               <Nav.Link as={Link} to="/hr/jobs/:id/applicants">View Applicants</Nav.Link>
//               <Nav.Link as={Link} to="/hr/jobs/:id/passed-applicants">View Passed Applicants</Nav.Link>
//             </>
//           )}
//         </Nav>
//         <Nav>
