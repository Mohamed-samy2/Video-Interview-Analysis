...
// const RoleRedirect = () => {
//   const { hrId, role } = useAuth();
//   if (hrId && role === 'hr') return <Navigate to="/hr" replace />;
//   return null; // Allow guests to stay on /
// };

// // HrProtectedRoute (assuming this exists)
// const HrProtectedRoute = ({ children }) => {
//   const { hrId } = useAuth();
//   if (!hrId) return <Navigate to="/hr/login" replace />;
//   return children;
// };
  ...
  createRoutesFromElements(
    <>
      ...
      <Route element={<LoginLayout />}>
        ...
        <Route path="/hr/create" element={<LoginSignup initialAction="Sign Up" />} />
      ...
      <Route element={<UserLayout />}>
        {UserRoutes}
        <Route path="/" element={<UserHome />} /> {/* Changed from UserRoutes to UserHome */}
